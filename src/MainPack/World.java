...
public class World {
	...
	public final static float PLAYERSTARTPOSITIONX = 64000;
	public final static float PLAYERSTARTPOSITIONY = 64000;
	...
	public final static int CHUNK_SIZE = WORLDSIZE/50;
}
